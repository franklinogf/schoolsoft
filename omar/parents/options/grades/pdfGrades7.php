...
foreach ($students as $estu) {
    ...
    foreach ($cursos as $curso) {
        ...
        if ($colegio->tri >= '1' and !empty($curso->nota1)) {
            if ($curso->credito > 0) {
        ...
        if ($colegio->tri >= '2' and !empty($curso->nota2)) {
            if ($curso->credito > 0) {
        ...
        //****************************************************
        if ($colegio->tri >= '3' and !empty($curso->nota3)) {
            if ($curso->credito > 0) {
        ...
        if ($colegio->tri >= '4' and !empty($curso->nota4)) {
            if ($curso->credito > 0) {
    ...
    $nnf1 = '';
    if ($colegio->tri >= '2' and $cr5 > 0) {
        $nnf1 = VPuntos(round($notas5 / $cr5, 2));
    }
    $pdf->Cell(10, 5, $nnf1, 1, 0, 'C', true);
    $nnf1 = '';
    if ($colegio->tri >= '3' and $cr3 > 0) {
    ...
    $pdf->Cell(14, 5, $nnf2, 1, 0, 'C', true);
    $nnf1 = '';
    if ($colegio->tri >= '4' and $cr6 > 0) {
        $nnf1 = VPuntos(round($notas6 / $cr6, 2));
    }
    $pdf->Cell(10, 5, $nnf1, 1, 0, 'C', true);
    $nnf1 = '';
    if ($colegio->tri >= '4' and $cr7 > 0) {
        $nnf1 = VPuntos(round($notas7 / $cr7, 2));
    }
    $pdf->Cell(14, 5, $nnf1, 1, 0, 'C', true);
    $pdf->Cell(10, 5, number_format($tcrs, 2), 1, 1, 'R', true);
}
