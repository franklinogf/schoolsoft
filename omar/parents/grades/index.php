...
<body>
    ...
    <div class="container mt-3">
        <h1 class="text-center my-2"><?= __("Notas diarias") ?></h1>
        <?php if ($parents->activo == 'Activo') : ?>
            <div class="jumbotron mt-3">
                <p><?= __("Yo, padre, madre o encargado, certifico que veré las notas diarias de mi hijo(a) a través del Internet. El sistema guardará un recibo en evidencia de que ví las notas diarias en curso") ?></p>
            ...
            <form action="<?= Route::url('/parents/grades/gradesOptions.php') ?>" method="GET">
                ...
                <button id="gradesBtn" type="submit" class="btn btn-primary mt-3" disabled><?= __("Notas diarias") ?></button>
            </form>
        <?php else : ?>
            <div class="jumbotron mt-3 border-danger">
                <div class="alert alert-danger" role="alert">
                    <?= nl2br($school->men_inac) ?>
                </div>
            </div>
        <?php endif ?>
    </div>
