    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown text-right">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropDownAccount">
          ...
          <a class="dropdown-item  <?= ($pathFile === 'inbox' ? 'active' : '') ?>" href="<?= Route::url('/foro/profesor/inbox.php') ?>"><i class="far fa-envelope text-secondary"></i> Mensajes <span class="badge badge-pill badge-primary">0</span></a>
          <div class="dropdown-divider"></div>
