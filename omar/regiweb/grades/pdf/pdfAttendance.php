...
$pdf->SetLeftMargin(5);
$pdf->AddPage();
$pdf->SetTitle('Informe de asistencia');
$pdf->Fill();

$pdf->SetFont('Arial', 'B', 12);
$pdf->Cell(0, 5, utf8_decode('Año Escolar'), 0, 1, 'C');
...
$pdf->Cell(0, 5, 'Informe de estudiantes con problemas de tardanzas o ausentismo por horario de clase', 0, 1, 'C');
$pdf->Ln();
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(20, 5, 'Maestro(a)');
$pdf->Cell(75, 5, utf8_decode($teacher->fullName()), 'B');

if ($_class === 'grado') {
    $pdf->Cell(20, 5, 'Grado:', 0, 0, 'C');
    ...
    $pdf->Cell(25, 5, 'Asignatura:', 0, 0, 'C');
...
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(10, 5, '', 1);
$pdf->Cell(70, 5, 'Nombre del estudiante', 1, 0, 'C');
$pdf->Cell(20, 5, 'Horario', 1, 0, 'C');
$pdf->Cell(25, 5, 'Ausencias', 1, 0, 'C');
$pdf->Cell(25, 5, 'Tardanzas', 1, 0, 'C');
