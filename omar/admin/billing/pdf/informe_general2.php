...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $data1 = "select * from padres4 where curso = '$_POST[curso]' AND year='$row[43]' ORDER BY apellidos, nombre";
...
while ($row1 = mysql_fetch_array($result)) {
    ...
    $mm2 = 0;
    for ($b1 = 1; $b1 <= 12; $b1++) {
        $q2 = "select * from padres4 where ss='$row1[0]' AND year='$row4[43]'AND curso='$row2[$b1]' ORDER BY curso";
        ...
        while ($row = mysql_fetch_array($result2)) {
            ...
            if ($cc == 'D') {
                ...
                for ($c = 1; $c <= 12; $c++) {
                    $data4a = "select * from padres4 where year = '$row4[43]' AND ss = '$row1[0]' AND curso = '" . $elec[$c] . "'";
            ...
            if ($cc == 'D') {
                $ll = $ll - 14;
                $data8 = "select * from asispp where ss = '$row1[0]' AND fecha >= '$row4[44]' AND fecha <= '$row4[45]'";
               ...
               if ($row8[10] != '15') {
                ...
                $data8 = "select * from asispp where ss = '$row1[0]' AND fecha >= '$row4[46]' AND fecha <= '$row4[47]'";
               ...
               if ($row8[10] != '15') {
                ...
                $data8 = "select * from asispp where ss = '$row1[0]' AND fecha >= '$row4[48]' AND fecha <= '$row4[49]'";
                $tabla22 = mysql_query($data8, $con) or die("problema con query 22");
                $au = 0;
                $ta = 0;
                while ($row8 = mysql_fetch_array($tabla22)) {
               ...
               if ($row8[10] != '15') {
                ...
                $data8 = "select * from asispp where ss = '$row1[0]' AND fecha >= '$row4[50]' AND fecha <= '$row4[51]'";
                $tabla22 = mysql_query($data8, $con) or die("problema con query 22");
                $au = 0;
                $ta = 0;
                while ($row8 = mysql_fetch_array($tabla22)) {
                ...
                for ($m1 = 1; $m1 <= 8; $m1++) {
                    ...
                    if ($m1 == 8) {
                        if ($gr > 8 and $tc > 0) {
                            ...
                            //            $pdf->Cell(45,5,'PROMEDIO SEM:   '.number_format(ROUND($tn / $tc,2),2).' '.$tn.' / '.$tc,'LRB',1,'L');
                            //            $pdf->Cell(45,5,'PROMEDIO SEM:   '.ROUND($tn / $tc,2),'LRB',0,'L');
                            //            $pdf->Cell(45,5,'PROMEDIO SEM:   '.$tn .'/'. $tc,'LRB',1,'L');
                        } else {
