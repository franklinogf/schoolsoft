...
<head>
    ...
    <?php
    $title = $lang->translation('Informes Diarios') . ' ' . $year;
...
<body>
    <div class="container-lg mt-lg-3 mb-5 px-0">
        <h1 class="text-center mb-3 mt-5"><?= $lang->translation('Informes Diarios') . ' ' . $year ?></h1>
        <div class="container bg-white shadow-lg py-3 rounded mx-auto" style="width: 50rem;">
            <div class="div">


                <form id="algunNombre" name="algunNombre" method="post" action="pdf/inf_diario.php" target="_blank">
                    <table align="center" cellpadding="2" cellspacing="0" style="width: 50%">
                        ...
                        <tr>
                            <td class="style4" style="height: 23px">
                                <input type='date' id='cal-field-1' name=ft1 maxlength=10 size=10 tabindex='1' value='<?= $fec; ?>' />
                            </td>
                            <td class="style4" style="height: 23px">
                                <input type='date' id='cal-field-2' name=ft2 maxlength=10 size=10 tabindex='1' value='<?= $fec; ?>' />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="style4" style="height: 23px">
                                <input type="text" class="form-control" name=t1 id="time1" required disabled="disabled" value="15:02:00" maxlength="8" />
                            </td>
                            <td class="style4" style="height: 23px">
                                <input type="text" class="form-control" name=t2 id="time2" required disabled="disabled" value="15:01:00" maxlength="8" />
                            </td>
                        </tr>
                        <tr>
