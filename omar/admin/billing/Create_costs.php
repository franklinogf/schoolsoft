...
IF(isset($_POST['pro']))
  ...
  if ($_POST['grado']=='Todos')
     {
     $resultado1 = DB::table('year')->
     whereRaw("year='$year' and activo = ''")->
     orderBy('grado')->get();
//     ]);
     }
   else
     ...
     if ($_POST['grado']=='Selección')
        {
     $resultado1 = DB::table('year')->
     whereRaw("id='".$_POST['cta']."' and year='$year' and activo = ''")->
     orderBy('grado')->get();
        }
     else
        {
     $resultado1 = DB::table('year')->
     whereRaw("grado='".$_POST['grado']."' and year='$year' and activo = ''")->
     orderBy('grado')->get();
        }
     }
...
foreach ($resultado1 as $row1)
      ...
      IF ($_POST['borrar']=='Si')
         ...
         if ($_POST['m1']==1)
            {
//            $q = "delete FROM pagos where fecha_d='".$y2.'-01-01'."' and year='$year' and id='$row1->id' and ss='$row1->ss' and deuda<>0";
      ...
      if ($_POST['cargos']=='Todos')
         {
     $resultado2 = DB::table('costos')->
     whereRaw("year='$year' and activo='Si' and grado='$row1->grado'")->
     orderBy('grado, codigo')->get();
         }
      else
         {
     $resultado2 = DB::table('costos')->
     whereRaw("codigo='".$_POST['cargos']."' and year='$year' and activo='Si' and grado='$row1->grado'")->
     orderBy('grado, codigo')->get();
         }
      list($ca1,$ca2) = explode(", ",$row1->desc1);
      list($cb1,$cb2) = explode(", ",$row1->desc2);
      list($cc1,$cc2) = explode(", ",$row1->desc3);
      
      if ($row1->nuevo=='Si' and !empty($row3->esncodigo))
         {
     $row5 = DB::table('presupuesto')->
     whereRaw("codigo='$row3->esncodigo' and year='$year'")->
    ...
    foreach ($resultado2 as $row2)
            ...
            for ($i = 1; $i <= 12; $i++) 
                {
                IF ($i<8){$i2=$i+6; $fe=$y2.'-'.$i.'-01';}
                IF ($i>7){$i2=$i-6; $fe=$y1.'-'.$i.'-01';}
//                IF ($i==12){$i2=6; $fe=$y1.'-'.$i.'-01';}
                ...
                IF ($row2->esn=='' and $row2->pf=='Si' and $mes[$i]=='Si')
                   {
                   $tabla1= DB::table('pagos')->
                   whereRaw("id='$row1->id' and year='$year' and fecha_d='$fe' and codigo='$row2->codigo' and code1='$row2->codigo'")->
                   orderBy('id')->get();
...
<?
  foreach ($tabla12 as $row2)
          {
          echo '<option value="'.$row2->codigo.'">'.$row2->descripcion.'</option>';
          }
?>
			</select></td>
	</tr>
	...
	<tr>
		<td class="style3">
			<strong><?= $lang->translation('Borrar todos los Cargos') ?></strong></td>
	</tr>
	<tr>
		<td class="style5">
	...
	<tr>
		<td class="style6">
			<strong><?= $lang->translation('Selección de Meses') ?></strong></td>
	</tr>
</table>
<table align="center" cellpadding="2" cellspacing="0" style="width: 550px">
	...
	<tr>
		<td class="style5"><center>
			<input checked="checked" disabled="disabled" name="m8" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
		<td class="style5"><center>
			<input checked="checked" disabled="disabled" name="m9" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
		<td class="style5"><center>
			<input checked="checked" disabled="disabled" name="m10" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
		<td class="style5"><center>
			<input checked="checked" disabled="disabled" name="m11" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
		<td class="style5"><center>
			<input checked="checked" disabled="disabled" name="m12" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
	</tr>
	...
	<tr>
		<td class="style5"><center>
			<input checked="checked" disabled="disabled" name="m1" type="checkbox" value="1" style="width: 20px; height: 20px"> </center>
		</td>
		<td class="style5"><center>
			<input checked="checked" disabled="disabled" name="m2" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
		<td class="style5"><center>
			<input checked="checked" disabled="disabled" name="m3" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
		<td class="style5"><center>
			<input checked="checked" disabled="disabled" name="m4" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
		<td class="style5"><center>
			<input checked="checked" disabled="disabled" name="m5" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="style5"><center>
			<input disabled="disabled" name="m6" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
		<td class="style5"><center>
			<input disabled="disabled" name="m7" type="checkbox" value="1" style="width: 20px; height: 20px"></center>
		</td>
		<td class="style5">
		</td>
		<td class="style5">
	...
	<tr>
		<td class="style3" colspan="5"><center><strong>
