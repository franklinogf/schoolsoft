...
$codes = DB::table('memos_codes')->get();
?>
<!DOCTYPE html>
<html lang="<?= __LANG ?>">
...
<head>
    <?php
    $title = $lang->translation('Códigos de memo');
...
<body>
    ...
    <div class="container-lg mt-lg-3 mb-5 px-0">
        <h1 class="text-center mb-3 mt-5"><?= $lang->translation('Códigos de memo') ?></h1>
        <div class="container bg-white shadow-lg py-3 rounded mx-auto" style="width: 35rem;">
            <div class="row">
                ...
                <?php foreach ($codes as $code) : ?>
                    <div class="col mb-4">
                        <div id="<?= $code->id ?>" class="card h-100">
                            ...
                            <div class="card-body">
                                <p class="card-text description"><?= $code->nombre ?></p>
                            </div>
                            <div class="card-footer text-center">
                                <button class="btn btn-primary edit" data-id=<?= $code->id ?>><?= $lang->translation("Editar") ?></button>
                                <button class="btn btn-danger del" data-id=<?= $code->id ?>><?= $lang->translation("Eliminar") ?></button>
                            </div>
                        </div>
                    </div>
                <?php endforeach ?>
