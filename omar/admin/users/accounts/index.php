                ...
                <div class="row mt-5">
                    ...
                    <div class="card col-12 p-3 rounded-0">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value='<?= isset($parents) ? $parents->id : $nextId ?>' class="form-control col" name='accountNumber' id="accountNumber" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4" for="username"><?= $lang->translation("Usuario y contraseña") ?></label>
                            <div class="col-sm-4">
                                <input type="text" value='<?= isset($parents) ? $parents->usuario : $nextId ?>' data-lastusername="<?= isset($parents) ? $parents->usuario : $nextId ?>" class="form-control" name='username' id="username" required>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <select class="form-control" name="exM" id="exM">
                                    ...
                                    <option <?= isset($parents) && $parents->ex_m === 'SI' ? 'selected=""' : '' ?> value="SI"><?= $lang->translation("SI") ?></option>
                                </select>
                            </div>
                            <div class="form-group col-12">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="cellCompanyM" class="form-control" name="cellCompanyM">
                                    <option <?= isset($parents) && $parents->cel_com_m === '' ? 'selected=""' : '' ?> value=""><?= $lang->translation("Seleccionar") ?></option>
                            ...
                            <div class="form-row col-12">
                                <div class="col-12">
                                    <input class="form-control" type="text" placeholder="<?= $lang->translation("Dirección") ?> 1" name="dir1" id="dir1" value="<?= isset($parents) ? $parents->dir1 : '' ?>" />
                                </div>
                                <div class="col-12 mt-1">
                                    <input class="form-control" type="text" placeholder="<?= $lang->translation("Dirección") ?> 2" name="dir3" id="dir3" value="<?= isset($parents) ? $parents->dir3 : '' ?>" />
                                </div>
                                <div class="col-5 mt-1">
                                    <input class="form-control" type="text" placeholder="<?= $lang->translation("Ciudad") ?>" name="city1" id="city1" value="<?= isset($parents) ? $parents->pueblo1 : '' ?>" />
                                </div>
                                <div class="col-3 mt-1">
                                    <input class="form-control" type="text" placeholder="<?= $lang->translation("Estado") ?>" name="state1" id="state1" value="<?= isset($parents) ? $parents->est1 : '' ?>" />
                                </div>
                                <div class="col-4 mt-1">
                                    <input class="form-control" type="text" placeholder="<?= $lang->translation("Codigo Postal") ?>" name="zip1" id="zip1" value="<?= isset($parents) ? $parents->zip1 : '' ?>" />
                                </div>
                            </div>
                            ...
                            <div class="form-row col-12">
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control" name="receiveEmailM" id="receiveEmailM">
                                        ...
                                        <option <?= isset($parents) && $parents->re_e_m === 'SI' ? 'selected=""' : '' ?> value="SI"><?= $lang->translation("SI") ?></option>
                                    </select>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control" name="receiveSmsM" id="receiveSmsM">
                                        ...
                                        <option <?= isset($parents) && $parents->re_mc_m === 'SI' ? 'selected=""' : '' ?> value="SI"><?= $lang->translation("SI") ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                ...
                                <select class="form-control" name="exP" id="exP" required>
                                    ...
                                    <option <?= isset($parents) && $parents->ex_p === 'SI' ? 'selected=""' : '' ?> value="SI"><?= $lang->translation("SI") ?></option>
                                </select>
                            </div>
                            <div class="form-group col-12">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="cellCompanyP" class="form-control" name="cellCompanyP">
                                    <option <?= isset($parents) && $parents->cel_com_p === '' ? 'selected=""' : '' ?> value=""><?= $lang->translation("Seleccionar") ?></option>
                                    <?php foreach (Util::phoneCompanies() as $company): ?>
                            ...
                            <div class="form-row col-12">
                                <div class="col-12">
                                    <input class="form-control" type="text" placeholder="<?= $lang->translation("Dirección") ?> 1" name="dir2" id="dir2" value="<?= isset($parents) ? $parents->dir2 : '' ?>" />
                                </div>
                                <div class="col-12 mt-1">
                                    <input class="form-control" type="text" placeholder="<?= $lang->translation("Dirección") ?> 2" name="dir4" id="dir4" value="<?= isset($parents) ? $parents->dir4 : '' ?>" />
                                </div>
                                <div class="col-5 mt-1">
                                    <input class="form-control" type="text" placeholder="<?= $lang->translation("Ciudad") ?>" name="city2" id="city2" value="<?= isset($parents) ? $parents->pueblo2 : '' ?>" />
                                </div>
                                <div class="col-3 mt-1">
                                    <input class="form-control" type="text" placeholder="<?= $lang->translation("Estado") ?>" name="state2" id="state2" value="<?= isset($parents) ? $parents->est2 : '' ?>" />
                                </div>
                                <div class="col-4 mt-1">
                                    <input class="form-control" type="text" placeholder="<?= $lang->translation("Codigo Postal") ?>" name="zip2" id="zip2" value="<?= isset($parents) ? $parents->zip2 : '' ?>" />
                                </div>
                            </div>
                            <h6 class="card-subtitle col-12 mt-4 mb-2"><?= $lang->translation("Información del trabajo") ?></h6>
                            <div class="form-row col-12">
                            ...
                            <div class="form-row col-12">
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control" name="receiveEmailP" id="receiveEmailP">
                                        ...
                                        <option <?= isset($parents) && $parents->re_e_p === 'SI' ? 'selected=""' : '' ?> value="SI"><?= $lang->translation("SI") ?></option>
                                    </select>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control" name="receiveSmsP" id="receiveSmsP">
                                        ...
                                        <option <?= isset($parents) && $parents->re_mc_p === 'SI' ? 'selected=""' : '' ?> value="SI"><?= $lang->translation("SI") ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card col-12 p-3 rounded-0">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-row col-12">
                                    <div class="col-12">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Dirección") ?> 1" name="inChargeDir1" id="inChargeDir1" value="<?= isset($parents) ? $parents->dir_e1 : '' ?>" />
                                    </div>
                                    <div class="col-12 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Dirección") ?> 2" name="inChargeDir2" id="inChargeDir2" value="<?= isset($parents) ? $parents->dir_e2 : '' ?>" />
                                    </div>
                                    <div class="col-5 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Ciudad") ?>" name="inChageCity" id="inChageCity" value="<?= isset($parents) ? $parents->pue_e : '' ?>" />
                                    </div>
                                    <div class="col-3 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Estado") ?>" name="inChageState" id="inChageState" value="<?= isset($parents) ? $parents->esta_e : '' ?>" />
                                    </div>
                                    <div class="col-4 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Codigo Postal") ?>" name="inChageZip" id="inChageZip" value="<?= isset($parents) ? $parents->zip_e : '' ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
