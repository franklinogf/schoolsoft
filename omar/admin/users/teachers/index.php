            ...
            <div class="col-12">
                <form method="POST">
                    <select class="form-control selectpicker w-100" name="teacherId" data-live-search="true" required>
                        <option value="">
                            <?= $lang->translation("Seleccionar") . ' ' . $lang->translation('maestro') ?>
                        </option>
        ...
        <?php if (isset($_REQUEST['teacherId']) || isset($_POST['new'])):
            ...
            <form method="POST" action="<?= Route::url('/admin/users/teachers/includes/index.php') ?>" enctype="multipart/form-data">
                <div class="row mt-5">
                    <div class="col-12 mb-3">
                        <h1 class="text-center mt-3">
                            <?= $lang->translation("Información del maestro") ?> <i class="far fa-id-card"></i>
                        </h1>
                    </div>
                    <div class="card col-12 col-md-6 p-3 rounded-0">
                        <div class="form-group row">
                            <label class="col-12 col-md-4" for="accountNumber">
                                <?= $lang->translation("Número de cuenta") ?>
                            </label>
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-4" for="username">
                                <?= $lang->translation("Usuario y contraseña") ?>
                            </label>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group text-center mt-2">
                            <button id="pictureBtn" type='button' class="btn btn-secondary">
                                <?= $lang->translation("Cambiar foto de perfil") ?>
                            </button>
                ...
                <div class="row mt-2">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <select name="gender" id="gender" class="form-control" required>
                                            ...
                                            <option <?= isset($_REQUEST['teacherId']) && $teacher->genero == "Masculino" ? 'selected' : '' ?> value="Masculino">
                                                <?= $lang->translation("Masculino") ?>
                                            </option>
                                            <option <?= isset($_REQUEST['teacherId']) && $teacher->genero == "Femenino" ? 'selected' : '' ?> value="Femenino">
                                                <?= $lang->translation("Femenino") ?>
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="dateOfBirth">
                                            <?= $lang->translation("Fecha de nacimiento") ?>
                                        </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        <label for="residentialPhone">
                                            <?= $lang->translation("Teléfono residencial") ?>
                                        </label>
                                    ...
                                    <div class="form-group col-6">
                                        <label for="emergencyPhone">
                                            <?= $lang->translation("Teléfono emergencias") ?>
                                        </label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="cellCompanyM">
                                            <?= $lang->translation("Compañia telefonica") ?>
                                        </label>
                                    ...
                                    <div class="form-group col-12">
                                        <label>
                                            <?= $lang->translation("Correo electrónico") ?>
                                        </label>
                                    ...
                                    <div class="form-group col-6">
                                        <label for="receiveEmail">
                                            <?= $lang->translation("Recibir correo electrónico") ?>
                                        </label>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-5">
                                <h5 class="card-subtitle text-center my-1">
                                    <?= $lang->translation("Dirección residencial") ?>
                                </h5>
                                <div class="form-row col-12">
                                    <div class="col-12">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Dirección") ?> 1" name="dir1" id="dir1" value="<?= isset($_REQUEST['teacherId']) ? $teacher->dir1 : '' ?>" />
                                    </div>
                                    <div class="col-12 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Dirección") ?> 2" name="dir2" id="dir2" value="<?= isset($_REQUEST['teacherId']) ? $teacher->dir2 : '' ?>" />
                                    </div>
                                    <div class="col-5 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Ciudad") ?>" name="city1" id="city1" value="<?= isset($_REQUEST['teacherId']) ? $teacher->pueblo1 : '' ?>" />
                                    </div>
                                    <div class="col-3 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Estado") ?>" name="state1" id="state1" value="<?= isset($_REQUEST['teacherId']) ? $teacher->esta1 : '' ?>" />
                                    </div>
                                    <div class="col-4 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Codigo Postal") ?>" name="zip1" id="zip1" value="<?= isset($_REQUEST['teacherId']) ? $teacher->zip1 : '' ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-2 d-flex my-3 my-lg-0 justify-content-center">
                                <button id="passAddress" class="btn btn-outline-primary align-self-center">
                                    <?= $lang->translation("Pasar dirección") ?> <i class="fas fa-angle-double-right d-none d-lg-block"></i> <i class="fas fa-angle-double-down d-lg-none"></i>
                                </button>
                            </div>
                            <div class="col-12 col-lg-5 ">
                                <h5 class="card-subtitle text-center my-1">
                                    <?= $lang->translation("Dirección Postal") ?>
                                </h5>
                                <div class="form-row col-12">
                                    <div class="col-12">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Dirección") ?> 1" name="dir3" id="dir3" value="<?= isset($_REQUEST['teacherId']) ? $teacher->dir3 : '' ?>" />
                                    </div>
                                    <div class="col-12 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Dirección") ?> 2" name="dir4" id="dir4" value="<?= isset($_REQUEST['teacherId']) ? $teacher->dir4 : '' ?>" />
                                    </div>
                                    <div class="col-5 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Ciudad") ?>" name="city2" id="city2" value="<?= isset($_REQUEST['teacherId']) ? $teacher->pueblo2 : '' ?>" />
                                    </div>
                                    <div class="col-3 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Estado") ?>" name="state2" id="state2" value="<?= isset($_REQUEST['teacherId']) ? $teacher->esta2 : '' ?>" />
                                    </div>
                                    <div class="col-4 mt-1">
                                        <input class="form-control" type="text" placeholder="<?= $lang->translation("Codigo Postal") ?>" name="zip2" id="zip2" value="<?= isset($_REQUEST['teacherId']) ? $teacher->zip2 : '' ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <h5 class="card-title text-center my-3">
                            <?= $lang->translation("Licencias de los maestros") ?>
                        </h5>
                    </div>
                    <div class="card col-12 p-3 rounded-0">
                        <?php for ($i = 1; $i <= 4; $i++): ?>
                    ...
                    <div class="col-12">
                        <h5 class="card-title text-center my-3">
                            <?= $lang->translation("Información de los Clubes") ?>
                        </h5>
                    </div>
                    <div class="card col-12 p-3 rounded-0">
                        <div class="row">
                            <div class="col-3">
                                <p class="text-center">
                                    <?= $lang->translation("Nombre del club") ?>
                                </p>
                            </div>
                            <div class="col-3">
                                <p class="text-center">
                                    <?= $lang->translation("Presidente") ?>
                                </p>
                            </div>
                            <div class="col-3">
                                <p class="text-center">
                                    <?= $lang->translation("Vice presindente") ?>
                                </p>
                            </div>
                            <div class="col-3">
                                <p class="text-center">
                                    <?= $lang->translation("Secretario(a)") ?>
                                </p>
                            </div>
                        </div>
                        <?php for ($i = 1; $i <= 5; $i++): ?>
                ...
                <div class="col-12 text-center mt-2">
                    <button id="submit" class="btn btn-primary btn-block" name="<?= isset($_REQUEST['teacherId']) ? 'edit' : 'save' ?>" type="submit">
