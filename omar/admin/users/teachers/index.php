                        ...
                        <div class="form-group col-6">
                            <label for="type">
                                ...
                                <select name="type" id="type" class="form-control" required>
                                    ...
                                    <option <?= $teacher->docente === 'Docente' ? 'selected' : '' ?> value="Docente">
                                        <?= $lang->translation("Docente") ?>
                                    </option>
                                    <option <?= $teacher->docente === 'No Docente' ? 'selected' : '' ?> value="No Docente">
                                    ...
                                    <div class="form-group col-6">
                                        <label for="gender">
                                            ...
                                            <select name="gender" id="gender" class="form-control" required>
                                                ...
                                                <option <?= $teacher->genero == "Masculino" ? 'selected' : '' ?> value="Masculino">
                                                    <?= $lang->translation("Masculino") ?>
                                                </option>
                                                <option <?= $teacher->genero == "Femenino" ? 'selected' : '' ?> value="Femenino">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        <label for="level">
                                            ...
                                            <select name="level" id="level" class="form-control">
                                                ...
                                                <option <?= $teacher->nivel === 'Pre-Escolar' ? 'selected' : '' ?> value="Pre-Escolar">
                                                    <?= $lang->translation("Preescolar") ?>
                                                </option>
                                                <option <?= $teacher->nivel === 'Elemental' ? 'selected' : '' ?> value="Elemental">
                                                    <?= $lang->translation("Elemental") ?>
                                                </option>
                                                <option <?= $teacher->nivel === 'Intermedia' ? 'selected' : '' ?> value="Intermedia">
                                                    <?= $lang->translation("Intermedia") ?>
                                                </option>
                                                <option <?= $teacher->nivel === 'Superior' ? 'selected' : '' ?> value="Superior">
                                                    <?= $lang->translation("Superior") ?>
                                                </option>
                                                <option <?= $teacher->nivel === 'Secundaria' ? 'selected' : '' ?> value="Secundaria">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <select name="home" id="home" class="form-control">
                                                ...
                                                <?php foreach ($grades as $grade): ?>
                                                    <option <?= $teacher->grado === $grade->grado ? 'selected=""' : '' ?> value="<?= $grade->grado ?>">
                                                        <?= $grade->grado ?>
                                                    </option>
                                            <?php endforeach ?>
                                        </select>
                                    ...
                                    <div class="form-group col-12">
                                        <label for="department">
                                            ...
                                            <select name="department" id="department" class="form-control">
                                                ...
                                                <option <?= $teacher->dep == '0' ? 'selected=""' : '' ?> value="0">
                                                    <?= $lang->translation('Maestro') ?>
                                                </option>
                                                <?php foreach ($departments as $department): ?>
                                                    <option <?= $teacher->dep === $department->codigo ? 'selected=""' : '' ?> value="<?= $department->codigo ?>">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="cellCompanyM">
                                            ...
                                            <select id="cellCompanyM" class="form-control" name="cellCompanyM">
                                                <option <?= $teacher->comp === '' ? 'selected=""' : '' ?> value="">
                                                    <?= $lang->translation("Seleccionar") ?>
                                                </option>
                                                <?php foreach (Util::phoneCompanies() as $company): ?>
                                                    <option <?= $teacher->comp === $company ? 'selected=""' : '' ?> value="<?= $company ?>">
                                                        <?= $company ?>
                                                    </option>
                                            <?php endforeach ?>
                                        </select>
                                    ...
                                    <div class="form-group col-6">
                                        <label for="receiveEmail">
                                            ...
                                            <option <?= $teacher->re_e === 'SI' ? 'selected=""' : '' ?> value="SI">
                                                    <?= $lang->translation("Si") ?>
                                                </option>
                                            </select>
                                        </div>
                                        <div class="form-group col-6">
                                            ...
                                            <select class="form-control" name="active" id="active">
                                                <option <?= $teacher->baja === '' ? 'selected=""' : '' ?> value="">
                                                    <?= $lang->translation("Si") ?>
                                                </option>
