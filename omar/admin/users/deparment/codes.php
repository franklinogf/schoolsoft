...
Session::is_logged();
$lang = new Lang([
    ["C�digos Departamento", "Department codes"],
    ['Guardar', 'Save'],
    ['C�digo', 'Code'],
...
<head>
    <?php
    $title = $lang->translation('C�digos Departamento');
...
<body>
    ...
    <div class="container-lg mt-lg-3 mb-5 px-0">
        <h1 class="text-center mb-3 mt-5"><?= $lang->translation('C�digos Departamento') ?></h1>
        <div class="container bg-white shadow-lg py-3 rounded mx-auto" style="width: 25rem;">
            <div class="row">
                ...
                <div class="input-group mb-3 col-6">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><?= $lang->translation("C�digo") ?></span>
                    </div>
                ...
                <div class="input-group mb-3 col-12">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><?= $lang->translation("Descripci�n") ?></span>
                    </div>
                    ...
                    <div id="<?= $code->codigo ?>" class="col mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text float-right"><span class="badge text-bg-info code"><?= $code->codigo ?></span></p>
                            </div>
                            <div class="card-body">
