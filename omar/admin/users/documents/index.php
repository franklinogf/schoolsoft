...
?>
    <div class="container mt-5">
        ...
        <?php if (isset($_POST['student'])) : ?>
            <form id="documents" method="POST" action="<?= Route::url('/admin/users/documents/includes/index.php') ?>">
                        ...
                        <div class="col mb-3">
                            <div class="card h-100">
                                ...
                                <div class="card-footer">
                                    ...
                                    <input type="date" class="form-control" name="expirationDate<?=$index?>" id="expirationDate<?=$index?>" <?= $docu->fesp ?>>
