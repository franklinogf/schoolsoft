...
Session::is_logged();
$lang = new Lang([
    ['inactivacion de matr�cula', 'registration deactivation'],
    ['Activar o desactivar la reinscripci�n de padres para el a�o', 'Turn parent re-enrollment on or off for the year'],
    ['Apellidos', 'Last name'],
    ['Nombre', 'Name'],
    ['Grado', 'Grade'],
    ['Guardar', 'Save'],
    ...
    ['D�a de vencimiento', 'Expiration day'],
    ['Bloqueo autom�tico si debe la cuenta', 'Automatic blocking if the account owe'],
...
<head>
    <?php
    $title = $lang->translation('inactivacion de matr�cula');
...
<body>
    ...
    <div class="container-lg mt-lg-3 mb-5 px-0">
        <h1 class="text-center mb-3 mt-5"><?= $lang->translation('Activar o desactivar la reinscripci�n de padres para el a�o') . ' ' . $school->year() ?> </h1>
