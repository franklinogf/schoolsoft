        ...
        <div class="jumbotron pt-4 shadow">
            ...
            <div class="row">
                <div class="col-6 text-right">
                    <span class="badge text-bg-info"><?= $lang->translation("Nombre:") ?></span>
                </div>
                <div class="col-6"><?= $user ?></div>
                <div class="col-6 text-right">
                    <span class="badge text-bg-info"><?= $lang->translation("Grupo:") ?></span>
                </div>
                <div class="col-6"><?= $school->info("grupo") ?></div>
                <div class="col-6 text-right">
                    <span class="badge text-bg-info"><?= $lang->translation("Ultima entrada:") ?></span>
                </div>
                <div class="col-6"><?= $school->info("ufecha") ?></div>
                <div class="col-6 text-right">
                    <span class="badge text-bg-info"><?= $lang->translation("IP:") ?></span>
                </div>
                <div class="col-6"><?= $ip ?></div>
                <div class="col-6 text-right">
                    <span class="badge text-bg-info"><?= $lang->translation("Hora:") ?></span>
                </div>
