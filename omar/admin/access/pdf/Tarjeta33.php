...
foreach ($students as $estu) {
    ...
    $pdf->Ln(8);
    $pdf->Cell(0, 5, 'TRANSCRIPCI&#65533;N DE CREDITOS', 0, 1, 'C');
    ...
    $pdf->Cell(44, 6, utf8_encode('A&#65533;O ESCOLAR'), 1, 0, 'L', true);
    for ($i = 1; $i <= 8; $i++) {
    ...
    foreach ($cursos as $nombre => $curso) {
        ...
        for ($i = 1; $i <= 8; $i++) {
            ...
            //      $pdf->Cell(15, 6, $grade[1], 1, ($i == 8) ? 1 : 0, 'C');
    ...
    $pdf->Ln(5);
    $pdf->Cell(0, 5, utf8_encode("La informaci&#65533;n se obtuvo del r&#65533;cord acumulativo de la oficina del director(a). No tiene borrones ni tachaduras."), 0, 1);
    $pdf->Ln(5);
}
$pdf->Output();
