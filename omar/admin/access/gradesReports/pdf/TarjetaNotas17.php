...
foreach ($students as $estu) {
    ...
    $pdf->Cell(60, 5, $de, 1, 0, 'C');
    $pdf->Cell(50, 5, $se1, 1, 0, 'C');
    $pdf->Cell(50, 5, $se2, 1, 0, 'C');
    $pdf->Cell(15, 5, $fi, 1, 0, 'C');
    $pdf->Cell(15, 5, 'CR', 1, 1, 'C');

    $pdf->Cell(60, 5, '', 1, 0, 'R');
    $pdf->Cell(50, 5, $qq1, 1, 0, 'L');
    $pdf->Cell(50, 5, $qq2, 1, 0, 'L');
