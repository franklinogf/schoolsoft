...
Session::is_logged();
$lang = new Lang([
    ['Exportaci�n de data a Excel', 'Data export to Excel'],
    ['Selecci�n de Base de datos', 'Database Selection'],
    ['Selecci�na el a�o', 'Select the year'],
    ['Selecci�n', 'Selection'],
    ['Padres', 'Parents'],
    ['Estudiantes', 'Students'],
    ['A�o para transferir datos', 'Year to transfer data'],
    ['Notas', 'Grades'],
    ['Pagos', 'Payments'],
    ['Transferir', 'Transfer'],
    ...
    ['Limpiar', 'Clear'],
    ['Eliminar', 'Delete'],
    ['Est�s seguro que quieres borrar el curso?', 'Are you sure you want to delete the course?'],
]);
