...
$lang = new Lang([
	...
	['Estudiantes bajo nivel por grado', 'Under level students by grade']
]);
...
$pdf->Cell(30, 5, $lang->translation("Estudiantes"), 'TR', 0, 'C', true);
$pdf->Cell(count($_grades) * 10, 5, $lang->translation("Estudiantes bajo nivel por grado"), 'TR', 1, 'C', true);
