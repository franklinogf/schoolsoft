...
$lang = new Lang([
    ["Lista de Profesores", "Teachers list"],
    ['Profesor', 'Teacher'],
    ['ID', 'ID'],
    ['Celular', 'Cel Phone'],
    ['Grado', 'Grade'],
...
$year = $school->year();
$pdf = new PDF();
$pdf->SetTitle($lang->translation("Lista de Profesores") . " $year", true);
$pdf->Fill();

$pdf->AddPage();
$pdf->SetFont('Arial', 'B', 15);
$pdf->Cell(0, 5, $lang->translation("Lista de Profesores") . " $year", 0, 1, 'C');
