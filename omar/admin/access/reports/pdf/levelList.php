...
$year = $school->year();
$pdf = new PDF();
$pdf->SetTitle($lang->translation("Lista de Niveles") . " $year", true);
$pdf->Fill();

$pdf->AddPage();
$pdf->SetFont('Arial', 'B', 15);
$pdf->Cell(0, 5, $lang->translation("Lista de Niveles") . " $year", 0, 1, 'C');
...
$pdf->Cell(50, 5, $lang->translation("Nivel"), 1, 1, 'C', true);
$pdf->ln(2);
...
foreach ($teachers as $count => $teacher) {
    ...
    $pdf->Cell(50, 7, $teacher->nivel, 0, 1, 'C');
}
