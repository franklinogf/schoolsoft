...
<body>
        ...
        <div class="card border-info">
            <div class="card-body">
                <div class="row row-cols-1 row-cols-md-3">
                    <div class="col">
                        <p class="text-monospace"><?= $lang->translation("Curso:") ?> <span class="badge text-bg-info"><?= $_class ?> </span></p>
                    </div>
                    <div class="col">
                        <p class="text-monospace"><?= $lang->translation("Trimestre:") ?> <span class="badge text-bg-info"><?= str_replace('Trimestre', $lang->translation("Trimestre"), str_replace('-', ' ', $_trimester)) ?></span></p>
                    </div>
                    <div class="col">
                        <p class="text-monospace"><?= $lang->translation("Total de estudiantes:") ?> <span class="badge text-bg-info"><?= sizeof($students) ?></span></p>
                    </div>
                    <div class="col">
                        <p class="text-monospace"><?= $lang->translation("Entrando notas a:") ?> <span class="badge text-bg-info"><?= $lang->translation($_thisReport['title']) ?></span></p>
                    </div>
                    <div class="col">
                        <p class="text-monospace"><?= $lang->translation("Fecha de inicio:") ?> <span class="badge text-bg-info"><?= Util::formatDate($teacher->info($_dates[0]), true) ?></span></p>
                    </div>
                    <div class="col">
                        <p class="text-monospace"><?= $lang->translation("Fecha de cierre:") ?> <span class="badge text-bg-info"><?= Util::formatDate($teacher->info($_dates[1]), true) ?></span></p>
                    </div>
                    <div class="col">
                        <p class="text-monospace"><?= $lang->translation("Tipo de nota:") ?> <span class="badge text-bg-info"><?= $gradeInfo->nota_por === "1" ? $lang->translation("Porciento") : $lang->translation("Suma") ?></span></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <!-- Students list -->
        <form id="form" action="<?= Route::url('/admin/access/registration/includes/enterGrades.php') ?>" method="POST">
