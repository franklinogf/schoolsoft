...
$lang = new Lang([
    ...
    ["La hoja <b>NO</b> está disponible en estos momentos.", "The sheet is <b>NOT</b> currently available."],
...
<body>
    ...
    <div class="container-md mt-md-3 mb-md-5 px-0">
        <h1 class="text-center my-4"><?= $lang->translation("Hoja de progreso") ?></h1>
        <?php if ($parents->info('hdp') !== 'NO' || $parents->info('fec_t') <= Util::date()) : ?>
            <div class="jumbotron mt-3">
                <h5 class="text-center text-danger"><?= $lang->translation("La hoja <b>NO</b> está disponible en estos momentos.") ?></h5>
            </div>
        <?php else : ?>
            <div class="jumbotron mt-3">
            ...
            <form action="<?= Route::url('/parents/options/progress/pdfGrades.php') ?>" method="POST" target="_blank">
                <div class="form-row">
                ...
                <button id="gradesBtn" type="submit" class="btn btn-primary mt-3" disabled><?= $lang->translation("Hoja de progreso") ?></button>
            </form>
        <?php endif ?>
    </div>
