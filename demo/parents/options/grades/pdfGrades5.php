...
foreach ($students as $estu) {
    ...
    foreach ($result7 as $row8) {
        $a = $a + 1;
        if ($row8->codigo == 1) {
            $cod = 'Ausencia-situaci&#65533;n en el hogar';
            $li2 = $li2 + 1;
        }
        if ($row8->codigo == 2) {
            $cod = 'Ausencia-determinaci&#65533;n del hogar(viaje)';
            $li2 = $li2 + 1;
        }
        if ($row8->codigo == 3) {
        ...
        if ($row8->codigo == 15) {
            $cod = 'Ausencia-determinaci&#65533;n de la familia';
            $li2 = $li2 + 1;
        }
        if ($row8->codigo == 16) {
