...
<body>
    ...
    <div class="container-fluid mt-4">
        <h2 class="text-center mb-4"><?= __("Plan de Trabajo 2") ?></h2>
        ...
        <form id="workPlanForm" class="d-none">
            ...
            <div class="card mb-3">
                <div class="card-body bg-light">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control mb-2" name="tema1" maxlength="75" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control mb-2" name="tema2" maxlength="75">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control mb-2" name="tema3" maxlength="75">
                            <input type="text" class="form-control mb-2" name="tema4" maxlength="75">
                            <input type="text" class="form-control" name="tema5" maxlength="75">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body bg-light">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="espectativas" maxlength="120">
                    </div>
            ...
            <!-- Sección 3: Unidad y Capítulo -->
            <div class="card mb-3">
                <div class="card-body bg-light">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><strong><?= __("Unidad") ?>:</strong></label>
                                <input type="text" class="form-control" name="tema" maxlength="80">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><strong><?= __("Capítulo") ?>:</strong></label>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body bg-light">
                                    ...
                                    <div class="form-group">
                                        <div>
                                            <label for="ini1"><strong>1. <?= __("Inicio") ?>:</strong></label>
                                            <input type="checkbox" name="ini1" value="Si" id="ini1">
                                        </div>
                                        <div class="form-check">
                                    ...
                                    <div class="form-group">
                                        <div>
                                            <label for="des1"><strong>2. <?= __("Desarrollo") ?>:</strong></label>
                                            <input type="checkbox" name="des1" value="Si" id="des1">
                                        </div>
                                        <div class="form-check">
                                    ...
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <input type="checkbox" name="cie1" value="Si" id="cie1">
                                        </div>
                                        <div class="form-check">
                                ...
                                <div class="card-body bg-light">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="eva1"><?= __("Texto") ?></label>
                                        </div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" name="eva2" value="Si" id="eva2">
                                            <label class="form-check-label" for="eva2"><?= __("Cuaderno") ?></label>
                                        </div>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" name="eva3" value="Si" id="eva3">
                                            <label class="form-check-label" for="eva3"><?= __("Fichas") ?></label>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-sm">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-sm" name="tab3" maxlength="18"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-sm" name="tab4" maxlength="18"></td>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="sel4"><?= __("Proyecto del día") ?></label>
                                            <div class="form-inline">
                                                <input type="text" class="form-control form-control-sm mx-1" name="pro1" maxlength="3" size="3">
                                                <?= __("al") ?>
                                                <input type="text" class="form-control form-control-sm mx-1" name="pro2" maxlength="3" size="3">
                                                <?= __("del mes") ?>
                                            </div>
                                        </div>
                                        <div class="form-check">
                                            ...
                                            <input type="text" class="form-control form-control-sm mt-1" name="otro" maxlength="60">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <input type="checkbox" name="as1" value="Si" id="as1">
                                        </div>
                                        <div class="form-check">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="autoeva" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function loadWorkPlan(planId) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Temas (plan2 tiene 5)
                    $('input[name="tema1"]').val(data.tema1);
                    $('input[name="tema2"]').val(data.tema2);
                    $('input[name="tema3"]').val(data.tema3);
                    $('input[name="tema4"]').val(data.tema4);
                    $('input[name="tema5"]').val(data.tema5);

                    $('input[name="espectativas"]').val(data.espectativas);
        ...
        // Auto-cargar plan si viene en URL
