    ...
    <div class="container-lg mt-lg-3  px-0">
        ...
        <form method="POST" action="<?=Route::url('/admin/access/includes/notesOptions.php')?>" class="p-5">
            ...
            <div class="row mt-4">
                ...
                <div class="col-12 mt-2">
                    <div class="form-group row">
                        ...
                        <select class="form-control col-sm-3" name="tri" id="tri">
                            <option <?= $school->info('tri') == '1' ? 'selected' : ''?> value="1">T-Q-1</option>
                            <option <?= $school->info('tri') == '2' ? 'selected' : ''?> value="2">T-Q-2</option>
                            <option <?= $school->info('tri') == '3' ? 'selected' : ''?> value="3">T-Q-3</option>
                            <option <?= $school->info('tri') == '4' ? 'selected' : ''?> value="4">T-Q-4</option>
                            <option <?= $school->info('tri') == '5' ? 'selected' : ''?> value="5">Q-5</option>
                            <option <?= $school->info('tri') == '6' ? 'selected' : ''?> value="6">Q-6</option>
                            <option <?= $school->info('tri') == '7' ? 'selected' : ''?> value="7">Q-7</option>
                            <option <?= $school->info('tri') == '8' ? 'selected' : ''?> value="8">Q-8</option>
                        </select>
                    </div>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label" for="ver"><?= $lang->translation("Grados");?></label>

                        <select class="form-control col-sm-3" name="ver" id="ver">
                            <option <?= $school->info('ver') == '1' ? 'selected' : ''?> value="1">Todos</option>
                            <option <?= $school->info('ver') == '2' ? 'selected' : ''?> value="2">08 y 12</option>
                        </select>
                ...
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <select class="form-control col-sm-3" name="tri1" id="tri1">
                            <option <?= $school->info('fra') == '1' ? 'selected' : ''?> value="1">T-Q-1</option>
                            <option <?= $school->info('fra') == '2' ? 'selected' : ''?> value="2">T-Q-2</option>
                            <option <?= $school->info('fra') == '3' ? 'selected' : ''?> value="3">T-Q-3</option>
                            <option <?= $school->info('fra') == '4' ? 'selected' : ''?> value="4">T-Q-4</option>
                            <option <?= $school->info('fra') == '5' ? 'selected' : ''?> value="5">Q-5</option>
                            <option <?= $school->info('fra') == '6' ? 'selected' : ''?> value="6">Q-6</option>
                            <option <?= $school->info('fra') == '7' ? 'selected' : ''?> value="7">Q-7</option>
                            <option <?= $school->info('fra') == '8' ? 'selected' : ''?> value="8">Q-8</option>
                        </select>
                    </div>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="form-group row">
                        ...
                        <select class="form-control col-sm-3" name="tri2" id="tri2">
                            <option <?= $school->info('hdt') == '1' ? 'selected' : ''?> value="1">T-Q-1</option>
                            <option <?= $school->info('hdt') == '2' ? 'selected' : ''?> value="2">T-Q-2</option>
                            <option <?= $school->info('hdt') == '3' ? 'selected' : ''?> value="3">T-Q-3</option>
                            <option <?= $school->info('hdt') == '4' ? 'selected' : ''?> value="4">T-Q-4</option>
                            <option <?= $school->info('hdt') == '5' ? 'selected' : ''?> value="5">Q-5</option>
                            <option <?= $school->info('hdt') == '6' ? 'selected' : ''?> value="6">Q-6</option>
                            <option <?= $school->info('hdt') == '7' ? 'selected' : ''?> value="7">Q-7</option>
                            <option <?= $school->info('hdt') == '8' ? 'selected' : ''?> value="8">Q-8</option>
                        </select>
                    </div>
                </div>
