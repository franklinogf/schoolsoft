...
if (isset($_REQUEST['search'])) {
    $thisCourse = Subject::query()->find($_REQUEST['course']);
}

if (isset($_REQUEST['save'])) {
    $teacher = Teacher::find($_POST['teacherId']);
...
$teachers = Teacher::query()->where('activo', 'Activo')->orderBy('apellidos')->get();
?>
<!DOCTYPE html>
<html lang="<?= __LANG ?>">
