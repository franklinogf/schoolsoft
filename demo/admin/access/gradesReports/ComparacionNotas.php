...
<head>
    <?php
    $title = $lang->translation('Comparación de notas');
...
<body>
    ...
    <div class="container-lg mt-lg-3 mb-5 px-0">
        <h1 class="text-center mb-3 mt-5">
            <?= $lang->translation('Comparación de notas') ?>
        </h1>
        <a href="<?= Route::url('/admin/access/gradesReports/') ?>" class="btn btn-secondary mb-2"><?= $lang->translation("Atrás") ?></a>
        <div class="container bg-white shadow-lg py-3 rounded">
            <form id="TarjetaNotas2" name="TarjetaNotas2" method="POST" target="_blank" action="<?= Route::url('/admin/access/gradesReports/pdf/ComparacionNotas.php') ?>">
                <div class="mx-auto" style="max-width: 500px;">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select id="nota" name="nota" class="form-control" required>
                               ...
                               <option value='3'><?= $lang->translation('Promedio final') ?></option>
                        </select>
                    </div>
                    <div class="input-group mb-3">
