...
if (isset($_REQUEST['search'])) {
    $thisCourse = DB::table('mensa_tarjeta')->where('codigo', $_REQUEST['course'])->first();
}
if (isset($_REQUEST['save'])) {
    $thisCourse = DB::table('mensa_tarjeta')->where('codigo', $_REQUEST['courseId'])->update([
        'text' => $_POST['text'],
        'grupo' => $_POST['grupo'],
...
if (isset($_REQUEST['delete'])) {
    DB::table('mensa_tarjeta')->where('codigo', $_REQUEST['courseId'])->delete();
}
$courses = DB::table('mensa_tarjeta')->orderBy('titulo')->get();
