...
//    $pdf->Cell(20, 5, 'ID', 1, 0, 'C', true);
    ...
    $pdf->Cell(40, 5, $lang->translation("Hora"), 1, 0, 'C', true);
    $pdf->Cell(100, 5, $lang->translation("IP"), 1, 1, 'C', true);
    $pdf->SetFont('Arial', '', 9);
...
//        $pdf->Cell(20, 5, $attendance->id, 1, 0, 'C');
        ...
        $pdf->Cell(40, 5, $attendance->hora, 1, 0, 'C');
        $pdf->Cell(100, 5, $attendance->ip, 1, 1, 'C');
    }
} else {
...
//                       $pdf->Cell(20, 5, $attendance->id, 1);
                       $pdf->Cell(30, 5, $attendance->fecha, 1);
                       $pdf->Cell(40, 5, $attendance->hora, 1, 0, 'C');
                       $pdf->Cell(100, 5, $attendance->ip, 1, 1, 'C');
                       $count++;
                       }
