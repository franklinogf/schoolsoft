...
//function footers1($a7)
function footer()
{
    $this->SetXY(10, -5);
    $this->SetMargins(10, -5);
    $this->SetFont('Arial', 'B', 10);
    $this->Cell(0, 5, utf8_encode('**La Persona que coteje el documento, escribe y firma su nombre sobre la l&#65533;nea correspondiente.'), 0, 0, 'C');
}
