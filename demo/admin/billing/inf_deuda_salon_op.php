...
<head>
    ...
    <?php
    $title = $lang->translation('Lista de Deudores por Salón Hogar');
...
<body>
    ...
    <div class="container-lg mt-lg-3 mb-5 px-0">
        <h1 class="text-center mb-3 mt-5"><?= $lang->translation('Lista de Deudores por Salón Hogar') ?></h1>
        <div class="container bg-white shadow-lg py-3 rounded mx-auto" style="width: 50rem;">
            <div class="div">

                <form action="pdf/inf_deuda_salon.php" method="post" target="_blank">
                    <div class="style4">
