                            ...
                            <?php if (isset($debtData[$number])): ?>
                                <?php foreach ($debtData[$number] as $charge): ?>
                                    <tr data-id="<?= $charge->codigo ?>" data-ss="<?= $charge->ss ?>" data-grade="<?= $charge->grado ?>"
                                        ...
                                        <td><?= PaymentTypeEnum::tryFrom($charge->tdp)?->getLabel() ?></td>
                        ...
                        <div class="form-row">
                            <div class="form-group col-6">
                                ...
                                <select class="form-control" id="paymentType" name="paymentType">
                                    <?php foreach (PaymentTypeEnum::cases() as $paymentType): ?>
                                        <option value="<?= $paymentType->value ?>"><?= $paymentType->getLabel() ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="form-group col-6">
