...
<body class="text-center">
   ...
   <form class="form-signin" method='POST' action="<?= Route::url('/admin/includes/login.php') ?>">
      ...
      <div class="input-group">
         ...
         <input type="text" id="username" name="username" class="form-control" placeholder="<?= __("Usuario") ?>" autofocus>
      </div>
      ...
      <div class="input-group">
         ...
         <input type="password" id="password" name="password" class="form-control mb-0" placeholder="<?= __("Contraseña") ?>">
      </div>
