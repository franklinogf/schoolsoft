...
<body>
   ...
   <div class="container mt-5 pb-5">
      <h1 id="header" class="text-center"><?= !isset($_GET['class']) ? __("Mis Cursos") : __('Mis temas') ?></h1>
      ...
      <?php else: ?>
         <!-- leyend -->
         <div class="card mx-auto bg-gradient-light bg-light leyend mb-3" style="max-width: 30rem">
         ...
         <!-- topics table -->
         <button id="newTopic" type="button" class="btn btn-secondary"><i class="far fa-comment"></i> <?= $lang->translation("Nuevo tema") ?> </button>
         ...
         <table class="topicsTable table table-striped table-hover cell-border w-100 shadow table-pointer">
            ...
            <tfoot>
               ...
               <tr class="bg-gradient-light bg-light">
                  <td colspan="4"><a href="<?= Route::url("/foro/profesor/topics.php") ?>" class="btn btn-block btn-primary"><?= $lang->translation("Atrás") ?></a></td>
               </tr>
            </tfoot>
         </table>
